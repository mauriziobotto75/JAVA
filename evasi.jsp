...
<%
  ...
  try {
    ...
    ResultSet r = s.executeQuery("SELECT * FROM intestazioni_ordini where evaso = 1 ORDER BY Data DESC");
...
<html xmlns="http://www.w3.org/1999/XHTML" xml:lang="it" lang="it">
 ...
 <!--  <script>
function myFunction() {
    confirm("Sei sicuro di voler cancellare?");
}
</script>-->
  </head>
  <body>
    <table width="100%">
      ...
      <tr>
        ...
        <td width="90%" style="text-align: center">
          ...
          %>
              <div class="intestazione">&nbsp;</div>
              <div class="intestazione">Ordini evasi:</div>
              <div class="intestazione">&nbsp;</div>
          ...
          %>
                  <tr>
                    ...
                    <td class='<%= stile%>'><a href="ripristina.jsp?id=<%= !testId ? o.numero : 0%>"><%= !testId ? "ripristina" : "nascondi dettagli"%></a></td>
                    <td class='<%= stile%>'><a onclick="myFunction()" href="cancella.jsp?id=<%= !testId ? o.numero : 0%>"><%= !testId ? "cancella" : "annulla"%></a></td>
                  </tr>
          <%
                  if(testId) {
          %>
